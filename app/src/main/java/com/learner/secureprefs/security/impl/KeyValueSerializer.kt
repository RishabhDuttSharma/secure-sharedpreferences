...
object KeyValueWrapper {
    ...
    fun serialize(pair: Pair<String, String>): String {
    ...
    fun deserialize(base64Input: String): Pair<String, String> = ByteBuffer.wrap(Base64.decode(base64Input, Base64.NO_WRAP)).run {
